    ...
    computed: {
      ...
      payDesc () {
        if (this.totalPrice === 0) {
          ...
          let defPrice = this.minPrice - this.totalPrice
          return `还差￥${defPrice}元起送`;
        } else {
          return '去结算';
        }
      },
  ...
  .shopcart
    ...
    .ball-container
      .ball
        ...
        bottom: 22px
        z-index: 200
        // 动画过度的时候小球的路径曲线 cubic-bezier(0.49, -0.29, 0.75, 0.41)
        // 具体的可以去 http://cubic-bezier.com/#.17,.67,.83,.67 上查看
